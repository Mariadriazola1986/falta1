...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 24-11-2020 a las 01:23:27
...
(9, 47, 'ezeiza', 'french 161', 42322181);
...
INSERT INTO `grupos` (`ID_GRUPO`, `ID_USUARIO_CREADOR`, `NOMBRE`, `ID_FOTO`, `CANT_MIEMBROS`) VALUES
(1, 48, 'rasts', 1, 4),
(2, 52, 'morza', 2, 1),
(3, 46, 'medusa', 3, 2);
...
--
-- Volcado de datos para la tabla `grupos_solicitudes`
--

INSERT INTO `grupos_solicitudes` (`ID_SOLICITUD`, `ID_GRUPO`) VALUES
(1, 1),
(2, 1),
(3, 1),
(4, 2),
...
(10, 4, 'cancha 5.jpg'),
(11, 4, 'cancha5.2.jpg'),
(12, 5, 'cancha 11 .2.jpg'),
(15, 5, 'cancha 11.3.jpg'),
(17, 5, 'cancha 11.jpg'),
(21, 5, 'cancha11.4.jpg'),
(26, 5, 'cancha11.5.jpg'),
(32, 9, 'cancha  de playa.jpg'),
(33, 9, 'cancha playa 2.jpg'),
(34, 9, 'cancha playa 3.jpg'),
(37, 9, 'cancha playa 4.jpg'),
(41, 9, 'cancha playa 5.jpg');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `invitacion_a_partido_a_grupo`
--

CREATE TABLE `invitacion_a_partido_a_grupo` (
  `ID_PARTIDO` int(11) NOT NULL,
  `ID_GRUPO` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Volcado de datos para la tabla `invitacion_a_partido_a_grupo`
--

INSERT INTO `invitacion_a_partido_a_grupo` (`ID_PARTIDO`, `ID_GRUPO`) VALUES
(117, 1),
(118, 1),
(119, 3);
...
(117, 46, '2020-11-27', '16:00:00', '17:00:00', 2, 4),
(118, 48, '2020-11-28', '22:00:00', '23:20:00', 4, 4),
(119, 44, '2020-11-25', '10:00:00', '11:00:00', 2, 2);
...
INSERT INTO `solicitudes` (`ID_SOLICITUD`, `ID_USUARIO`, `ESTADO_SOLICITUD`, `ID_TIPO_S`) VALUES
(1, 52, 1, 1),
(2, 52, 1, 1),
(3, 44, 1, 1),
(4, 44, 4, 1),
...
INSERT INTO `tipo_solicitudes` (`ID_TIPO_S`, `TIPO_S`) VALUES
(1, 'De Administrador'),
(2, 'De Jugador');
...
--
-- Indices de la tabla `invitacion_a_partido_a_grupo`
--
ALTER TABLE `invitacion_a_partido_a_grupo`
  ADD KEY `ID_PARTIDO` (`ID_PARTIDO`,`ID_GRUPO`),
  ADD KEY `ID_GRUPO` (`ID_GRUPO`);
...
--
ALTER TABLE `canchas`
  MODIFY `ID_CANCHA` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
...
--
ALTER TABLE `partidos`
  MODIFY `ID_PARTIDO` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=120;
...
--
ALTER TABLE `tipo_solicitudes`
  MODIFY `ID_TIPO_S` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
-- Filtros para la tabla `invitacion_a_partido_a_grupo`
--
ALTER TABLE `invitacion_a_partido_a_grupo`
  ADD CONSTRAINT `invitacion_a_partido_a_grupo_ibfk_1` FOREIGN KEY (`ID_GRUPO`) REFERENCES `grupos` (`ID_GRUPO`) ON UPDATE CASCADE,
  ADD CONSTRAINT `invitacion_a_partido_a_grupo_ibfk_2` FOREIGN KEY (`ID_PARTIDO`) REFERENCES `partidos` (`ID_PARTIDO`) ON UPDATE CASCADE;
...
ALTER TABLE `solicitudes`
  ...
  ADD CONSTRAINT `solicitudes_ibfk_3` FOREIGN KEY (`ID_TIPO_S`) REFERENCES `tipo_solicitudes` (`ID_TIPO_S`) ON DELETE NO ACTION ON UPDATE CASCADE;
