...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 01-11-2020 a las 19:07:40
...
INSERT INTO `partidos` (`ID_PARTIDO`, `ID_USUARIO`, `FECHA`, `HORA`, `HORA_FIN`, `TIPO_DE_FUTBOL`) VALUES
(50, 29, '2020-11-02', '20:00:00', '22:00:00', 1),
(51, 29, '2020-11-02', '16:00:00', '18:00:00', 1);
...
--
-- Estructura de tabla para la tabla `publicaciones_partidos`
--

CREATE TABLE `publicaciones_partidos` (
...
(29, 'mta', '$2y$10$i4ygT0QbRgTiL.YB4uiF7uyFRHvKslWZtDzerx6it29Zx/NnZY0Ga', 'mariaadriazola25@gmail.com', 1, 1, '');
...
CREATE TABLE `usuarios_juegan_partidos` (
  `ID_USUARIO` int(11) NOT NULL,
  `ID_PARTIDO_PUBLICADO` int(11) NOT NULL,
...
--
-- Indices de la tabla `publicaciones_partidos`
--
ALTER TABLE `publicaciones_partidos`
...
--
-- Indices de la tabla `usuarios_juegan_partidos`
--
ALTER TABLE `usuarios_juegan_partidos`
  ADD KEY `ID_USUARIO` (`ID_USUARIO`,`ID_PARTIDO_PUBLICADO`,`ID_INVITADO`),
  ADD KEY `ID_PARTIDO_PUBLICADO` (`ID_PARTIDO_PUBLICADO`),
...
--
ALTER TABLE `partidos`
  MODIFY `ID_PARTIDO` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=52;
...
--
-- AUTO_INCREMENT de la tabla `publicaciones_partidos`
--
ALTER TABLE `publicaciones_partidos`
...
ALTER TABLE `reservas`
  ...
  ADD CONSTRAINT `reservas_ibfk_2` FOREIGN KEY (`ID_PUBLICACION`) REFERENCES `publicaciones_partidos` (`ID_PUBLICACION`) ON UPDATE CASCADE,
...
--
-- Filtros para la tabla `usuarios_juegan_partidos`
--
ALTER TABLE `usuarios_juegan_partidos`
  ADD CONSTRAINT `usuarios_juegan_partidos_ibfk_1` FOREIGN KEY (`ID_USUARIO`) REFERENCES `usuarios` (`ID_USUARIO`) ON UPDATE CASCADE,
  ADD CONSTRAINT `usuarios_juegan_partidos_ibfk_2` FOREIGN KEY (`ID_PARTIDO_PUBLICADO`) REFERENCES `publicaciones_partidos` (`ID_PUBLICACION`) ON UPDATE CASCADE,
  ADD CONSTRAINT `usuarios_juegan_partidos_ibfk_3` FOREIGN KEY (`ID_INVITADO`) REFERENCES `invitados` (`ID_INVITADO`) ON UPDATE CASCADE;
COMMIT;
