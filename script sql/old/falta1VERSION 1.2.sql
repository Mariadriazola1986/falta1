...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 03-11-2020 a las 00:13:11
...
ALTER TABLE `usuarios_juegan_partidos`
  ADD UNIQUE KEY `ID_USUARIO_2` (`ID_USUARIO`,`ID_PARTIDO`,`ID_INVITADO`),
  ADD UNIQUE KEY `ID_USUARIO_3` (`ID_USUARIO`,`ID_PARTIDO`,`ID_INVITADO`),
  ADD KEY `ID_USUARIO` (`ID_USUARIO`,`ID_PARTIDO`,`ID_INVITADO`),
  ADD KEY `ID_INVITADO` (`ID_INVITADO`),
  ADD KEY `ID_PARTIDO_PUBLICADO` (`ID_PARTIDO`);
...
--
ALTER TABLE `partidos`
  MODIFY `ID_PARTIDO` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=90;
...
--
ALTER TABLE `usuarios_juegan_partidos`
  ADD CONSTRAINT `usuarios_juegan_partidos_ibfk_3` FOREIGN KEY (`ID_INVITADO`) REFERENCES `visitantes` (`ID_INVITADO`) ON UPDATE CASCADE,
  ADD CONSTRAINT `usuarios_juegan_partidos_ibfk_4` FOREIGN KEY (`ID_PARTIDO`) REFERENCES `partidos` (`ID_PARTIDO`) ON UPDATE CASCADE,
  ADD CONSTRAINT `usuarios_juegan_partidos_ibfk_5` FOREIGN KEY (`ID_USUARIO`) REFERENCES `usuarios` (`ID_USUARIO`) ON UPDATE CASCADE;
COMMIT;
