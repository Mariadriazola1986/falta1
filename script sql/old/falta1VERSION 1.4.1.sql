...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 10-11-2020 a las 03:08:34
...
(113, 46, '2020-11-20', '10:00:00', '12:00:00', 1, 2);
...
(11, 111, 'invitamos a los jugadores que faltan para juganr en el districto esteban echeverria en la cancha los alcones direccion moreno 345 el jaguel'),
(12, 113, 'se jugara en la reconcha de tu hermana');
...
(47, 'conejo', '$2y$10$/vbLphn0fRGQpB/CkKUY..M6YYaNYAlyAelilV.yM9JV/PtJUt5mi', 'conejo@gmail.com', 2, 1, ''),
(48, 'gallo', '$2y$10$M3ypvQWm.Bse9AvSokEjauLZ.ZjVv6blsNStJDypEv1lqeeO4cMEe', 'gallo25@gmail.com', 1, 1, '');
...
--
ALTER TABLE `partidos`
  MODIFY `ID_PARTIDO` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=114;
